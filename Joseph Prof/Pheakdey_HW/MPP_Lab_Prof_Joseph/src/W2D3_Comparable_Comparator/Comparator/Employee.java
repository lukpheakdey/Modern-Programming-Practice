...
public class Employee {
	...
	public static final Comparator SSN = new Comparator(){
		public int compare(Object o1, Object o2) {
			System.out.println("Name comparator is " + SSN.getClass().getName());
			System.out.println(NAME.getClass());
			String ssn1 = ((Employee)o1).getSsn();
			String ssn2 = ((Employee)o2).getSsn();
